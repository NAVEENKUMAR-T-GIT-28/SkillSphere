...
const findPending = (skip = 0, limit = 10) => Skill.find({ status: 'pending' }).skip(skip).limit(limit);
const countDocuments = (filter = {}) => Skill.countDocuments(filter);
...
module.exports = {
  ...
  findPending, countDocuments, aggregate
};
